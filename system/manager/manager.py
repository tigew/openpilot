...
def manager_thread() -> None:
  ...
  ensure_running(managed_processes.values(), False, params=params, CP=sm['carParams'], not_run=ignore, classic_model=False, frogpilot_model=False, frogpilot_toggles=get_frogpilot_toggles())
  ...
  while True:
    ...
    ensure_running(managed_processes.values(), started, params=params, CP=sm['carParams'], not_run=ignore, classic_model=classic_model, frogpilot_model=frogpilot_model, frogpilot_toggles=frogpilot_toggles)
