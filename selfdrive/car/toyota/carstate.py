...
class CarState(CarStateBase):
  ...
  def update(self, cp, cp_cam, CC, frogpilot_toggles):
    ...
    if self.CP.carFingerprint in (TSS2_CAR - RADAR_ACC_CAR - SECOC_CAR) or (self.CP.flags & ToyotaFlags.SMART_DSU and not self.CP.flags & ToyotaFlags.RADAR_CAN_FILTER):
