...
void PairingQRWidget::refresh() {
  ...
  QString qrString = (useKonikServer() ? "https://portal.konik.ai/?pair=" : "https://connect.comma.ai/?pair=") + pairToken;
...
PairingPopup::PairingPopup(QWidget *parent) : DialogBase(parent) {
  ...
  hlayout->addLayout(vlayout, 1);
  {
    ...
    QString serverUrl = useKonikServer() ? "portal.konik.ai" : "connect.comma.ai";
