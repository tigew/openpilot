...
void FrogPilotModelPanel::showEvent(QShowEvent *event) {
  ...
  downloadModelButton->setEnabledButtons(0, !allModelsDownloaded && !allModelsDownloading && !cancellingDownload && frogpilot_scene.online && parked);
  downloadModelButton->setEnabledButtons(1, !allModelsDownloaded && !modelDownloading && !cancellingDownload && frogpilot_scene.online && parked);
...
void FrogPilotModelPanel::updateState(const UIState &s, const FrogPilotUIState &fs) {
  ...
  downloadModelButton->setEnabledButtons(0, !allModelsDownloaded && !allModelsDownloading && !cancellingDownload && !finalizingDownload && frogpilot_scene.online && parked);
  downloadModelButton->setEnabledButtons(1, !allModelsDownloaded && !modelDownloading && !cancellingDownload && !finalizingDownload && frogpilot_scene.online && parked);
