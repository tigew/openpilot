...
private:
  ...
  QSet<QString> longitudinalKeys = {"FrogsGoMoosTweak", "LowSetSpeed", "SNGHack", "VoltSNG"};
  QSet<QString> subaruKeys = {"SubaruSNG"};
  QSet<QString> toyotaKeys = {"ClusterOffset", "FrogsGoMoosTweak", "LockDoorsTimer", "LowSetSpeed", "SNGHack", "ToyotaDSUBypass", "ToyotaDoors"};
