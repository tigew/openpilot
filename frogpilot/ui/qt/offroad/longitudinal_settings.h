...
private:
  ...
  QSet<QString> qolKeys = {"CustomCruise", "CustomCruiseLong", "ForceStops", "IncreasedStoppedDistance", "LowSpeedCruiseOverride", "MapGears", "ReverseCruise", "SetSpeedOffset", "WeatherPresets"};
